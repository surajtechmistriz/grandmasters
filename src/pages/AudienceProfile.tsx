...
const organizations = [
  ...
  ["Ani Technologies", "Ansal API", "ArcelorMittal Distribution Solutions India"],
  ["ARCIL", "Ardent Legal", "Aricent"],
  ["Ashland India", "Asianet Communications", "Asset Reconstruction Company India"],
  ["ATC Telecom Tower Cop.", "Athena Legal", "ATS Infrastructure"],
  ["Autodesk India", "Avantha Power & Infrastructure", "AZB & Partners"],
  ["B4U Television Network", "Balaji Telefilms and Balaji Motion Pictures", "Bank of Baroda"],
  ["Barclays Technology Centre India", "Bennett, Coleman & Co.", "Bharat Gears"],
  ["Bharti Airtel", "Bharti Axa General Insurance Co.", "Bharti Axa Life Insurance Co."],
  ...
  ["Capital Novus", "Capital One Services India", "Carl Bechem Lubricats India"],
  ["Carroll O'DEA Busines Lawyers", "Cello Writing Aids", "Chadha & Chadha"],
  ["Chess Management Services", "Cipla", "Cloudtail India"],
  ["Clutch Group", "Cognizant Technology Solutions India", "Competition Commission of India"],
  ["Complynium Solutions", "Computer Sciences Corp. India", "Comviva Technologies"],
  ...
  ["Cyril Amarchand Mangaldas", "Daimler India Commercial Vehicles", "Dalmia Bharat"],
  ["Datamatics Global Services", "Deepak Sabharwal & Associates", "Delhi International Airport"],
  ["Deloitte Touche Tohmatsu India LLP", "Dhawan & Co.", "Dhir and Dhir Associates"],
  ["Digicable Network India", "Directorate General of Hydrocarbons", "Dr. Reddy's Laboratories"],
  ["Dynamatic Technologies", "E.I. DuPont India", "EDAG Engineering & Design India"],
  ...
  ["Fabindia Overseas", "Fedders Lloyd Corporation", "Film Federation of India"],
  ...
  ["Future Lifestyle Fashions", "G4S Secure Solutions India", "Gamesa Wind Turbines"],
  ["Gates Unitta India Co.", "GE Capital", "General Motors India"],
  ["Genpact", "GlaxoSmithKline Consumer Healthcare", "Glenmark Pharmaceuticals"],
  ["Global Outsourcing Asia Operations", "Gnarus Partners", "Godrej Industries"],
  ...
  ["Hindustan Unilever", "Hitachi Consulting Software Services India", "Holman Fenwick Willan Singapore LLP"],
  ...
  ["IDFC Infrastructure Debt Fund", "IDFC Infrastructure Finance", "IL & FS Financial Services"],
  ["Imperium Legal", "Indian Farmers Fertiliser Co.", "Indian National Bar Association"],
  ["Indraprastha Gas", "Indus IntelliRisk & IntelliSense Service", "Indus Law"],
  ["Industrial Finance Corporation of India", "Infosys", "Infrastructure Leasing & financial Service"],
  ...
  ["Mcdonalds India North-East", "Mega Lifesciences", "Metro Cash & Carry India"],
  ...
  ["MultiScreen Media", "National Commodity & Derivatives Exchange", "Net App India"],
  ["Netrika Consulting", "New Delhi Law Offices", "Nielsen"],
  ["Nippon Paint India", "Nirma", "Nokia"],
  ["NTT DATA Global Delivery Services", "Nucleus Software Exports", "Oberoi Realty"],
  ...
  ["Primerus", "Proind Business Solutions", "Prudential Process Mgt. Ser. India"],
  ["PVR", "QuEST Global", "R K Dewan & Co."],
  ["R V College of Engineering", "Radhika Bali and Associates", "Radico Khaitan"],
  ...
  ["SABMiller India", "Saikrishna & Assocites", "Samsung R & D Institute India Banglore"],
  ...
  ["Siemens Industry Software India", "SILF", "Singapore International Arbitration Centre (SIAC)"],
  ["Sistema Shyam TeleServices", "Siva Group of Companies", "Snapdeal.com"],
  ["Sonata Software", "Spice Connect", "Spice Digital and"],
  ["Srei Infrastructure Finance", "Star CJ Network India", "State Bank of Mysore"],
  ["State Street Global Advisors, India", "Statkraft Markets", "Sterlite Technologies"],
  ["Strides Arcolab", "Strides Shasun", "Sudath Perera Associates"],
  ["Sumitomo Mitsu Banking Corporation", "Sun Pharma Advanced Research Company", "Suri & Company"],
  ["Suryalakshmi Cotto Mills", "Sword Global India", "Syngenta India"],
  ["TATA Motors Insurance Broking & Advisory Ser.", "Tata Realty", "Tata Services"],
...
const hierarchical = [
  ...
  ["Associate Director – Legal & Compliance", "Associate Director Human Resources", "Associate Manager – Legal Services"],
  ["Associate Principal – Quality Programs", "Associate V P & Head – IP Cell", "Associate Vice President & Head Legal"],
  ["Asst. Company Secretary", "Asst. General Manager – Legal", "Asst. Manager Legal"],
  ["Asst. Manager Legal", "Ast Director Legal", "Attorney Legal"],
  ["Attorney, India/South Asia", "Audit Program Manager Quality", "AVP – Head – Legal"],
  ["AVP – Legal Workflow Solutions", "Chief Executive Officer", "Chief Financial Officer"],
  ["Chief Legal & Secretarial", "Chief Legal Advisor", "Chief Legal and Compliance Officer"],
  ["Chief Legal and Regulatory Affairs Officer", "Chief Legal Officer", "Chief Manager HR"],
  ["Chief Manager Legal", "Chief Risk Officer and Vice President – Program Management & Process Excellence", "Company Secretary"],
  ["Company Secretary & Compliance Officer", "Company Secretary & DGM Head Legal – Sec.", "Compliance Officer"],
  ["Corporate Counsel", "Corporate Head Legal & Company Secretary", "Corporate Strategy & Planning"],
  ["Country Counsel – India", "Deputy General Manager – Legal", "Deputy Legal Advisor"],
  ["Deputy Manager – Finance Advisory Services", "Deputy Manager Law", "DGM – (Legal) & Company Secretary"],
  ["DGM – Legal", "DGM Regulatory Affairs", "Director"],
  ["Director – OP Finance", "Director Corporate Affairs & General Counsel -South Asia", "Director Forensic Services"],
  ["Director HR – QMS", "Director Intellectual Property Policy – Legal & Corporate Affairs (LCA)", "Director Legal"],
  ["Director Legal & Com. Sec.", "Director of Intellectual Property", "Director, Policy & Regulatory Affairs"],
  ["Dy Manager Law", "Dy. GM – Legal", "E.V.P. – Corporate Legal"],
  ["EVP- Group General Counsel", "Exe. Legal", "Exe. V P Legal & Arbitration"],
  ["Executive Director & Chief Financial Officer", "Executive Director Law", "Executive Online Sales"],
  ["Finance Advisory Services", "Former Chairman", "Founder & CEO"],
  ["Founder & Chief Operation Officer", "Founder & Managing Partner", "Founding Partner"],
  ["General Counsel", "General Counsel – Asia Pacific", "General Counsel & Group Head – Legal & Compliance"],
  ["General Counsel Asia Pacific", "Global General Counsel", "GM – Legal & CRM Compliance"],
  ["Group General Counsel", "Group General Counsel & Exe. V P", "Head – Corporate Legal"],
  ["Head – IP", "Head – Strategy & Client Engagement", "Head- Legal & Secretarial"],
  ["Head of Legal – Operations and Technology", "Head Syndication & Licensing", "Head-Legal & HR"],
  ["Independent Practitioner", "Investigator Ombuds & Open Reporting Legal Retail Finance", "Key Account Manager"],
  ["Lead Counsel- Global Technology Services", "Legal Counsel", "Legal Counsel & Com Sec. APJ Legal"],
  ["Legal Counsel & Company Secretary", "Legal Counsel APJ Legal Dpt.", "Legal Executive"],
  ...
  ["Partner", "Partner Private Equity and M&A", "Partner Transfer Pricing and Direct Tax"],
  ...
  ["Senior Consultant Risk Advisory Services", "Senior Counsel (India & South Asia)", "Senior Executive – Legal"],
  ["Senior Legal Officer", "Senior Manager – Forensic", "Senior Manager Forensic Services"],
]
