    ...
    <footer className="w-full">
      ...
      <div className="fixed bottom-8 right-4 md:bottom-22 md:right-6 z-50 group">
        ...
        <a
          ...
          className="absolute right-16 top-1/2 -translate-y-1/2 bg-[#25D366] text-white text-[15px] font-normal leading-6 px-3 py- rounded-lg opacity-0 group-hover:opacity-100 group-hover:translate-x-0 translate-x-2 transition-all duration-200 whitespace-nowrap cursor-pointer"
        >
          Get In Touch
        </a>
