    ...
    <section className="py-10 md:py-16 bg-white font-sans">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
        ...
        <div className="flex justify-center mb-4">
          <ThumbsUp className="text-[#d2232a] stroke-[1.5px] w-8 h-8 md:w-10 md:h-10" />
        </div>
        ...
        <p className="font-roboto text-gray-500 text-sm md:text-[15px] mb-8 md:mb-12 px-2">
          {" "}
          A Visual{" "}
<span className="text-[#d2232a] text-sm md:text-[15px] font-normal leading-relaxed md:leading-[28px]">            Overview of Past
          </span>{" "}
          Summit Proceedings
        </p>
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-1 mt-4">
            {images.map((img) => (
           <div key={img} className="aspect-[4/3] overflow-hidden bg-gray-100 group rounded-md">
              <img
