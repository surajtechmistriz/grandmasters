...
const GetInvolved = () => {
  return (
    <section className="relative min-h-[300px] flex items-center justify-center overflow-hidden">
      ...
      {/* Content Container */}
      <div className="relative z-10 container mx-auto px-38 py-10 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="w-full lg:w-1/2 max-w-md">
          <form className="space-y-4">
            <input
              type="text"
              placeholder="Name"
              className="w-full px-4 py-2 bg-white text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-400 transition-all"
            />
            <input
              type="email"
              placeholder="E-mail"
